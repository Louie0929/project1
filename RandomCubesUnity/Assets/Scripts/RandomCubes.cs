...
public class RandomCubes : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        gObj.transform.position = Random.insideUnitSphere; // random point inside a
                                                           // sphere radius of 1
        ...
        {
            float scale = goTemp.transform.localScale.x; // record sarting scale
        ...
        foreach(GameObject goTemp in removeList)
        {
            ...
            Destroy(goTemp); // destrop object from scene
